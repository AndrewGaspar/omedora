...
3. Check the allowed third-party COPRs (see the allowlist in [`packages.md` §7](packages.md#7-review-checklist)). The allowlist is currently empty — omedora-3 has no third-party COPR dependencies (the hyprwm stack was vendored as omedora's own RPMs in task #66).
...
- **Fedora packaging surprises:** "swayosd moved into Fedora main repos as of F45 — drop the COPR check." "omedora's own COPR was unreachable for 48 hours in March 2026; users hit `omedora update` failures."
