...
SPECS=(
  ...
  # builds). Built entirely from omedora's own COPR — no third-party COPRs.
  ...
  # uwsm (the session manager omedora launches through) isn't in Fedora
  # either — so it's vendored here too.
  uwsm.spec
