...
#
# Usage:
#   test/fedora/run-session.sh            # build if needed, boot, launch session
...
LAUNCH_IN_IMAGE=/home/omedora/.local/share/omarchy/test/fedora/omedora-session/session-launch.sh
